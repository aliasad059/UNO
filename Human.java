...
/**
 * a human can choose a card and play it manually
 */
public class Human extends Player {
    ...
    public void chooseCard() {
        ...
        // if the add card number is not equal to zero it means that a player plays a draw card
            ...
            // if the player has at least one draw card and can play it , he/she will decide to takes card or drop its draw card
            if (drawCards.size() != 0) {
     ...
     * @param deckToPrint deck of the player
     */
    ...
    /**
     * gives the ANSI color of text according to the card color
     * @param card the card
     * @return the ANSI color
     */
    private static String getANSICOLOR(Card card) {
    ...
    /**
     * gives the ANSI color of the background according to the card color
     * @param card the card
     * @return the ANSI color
     */
    private static String getANSICOLOR_BACKGROUND(Card card) {
        if (card.getColor().equals(Constants.colors[0]))
